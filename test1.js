...
contract('AuctionContract', function (accounts) {
  ...
  it("Should set winners", function() {
    ...
    ***********/
    return register({from: accounts[2]}).then(function(result) {
      /**********
      TASK 8: Call register function from account 3
      ***********/
        return register({from: accounts[3]});
    }).then(function() {
      /**********
      TASK 9: Call register function from account 4
      ***********/
        return register({from: accounts[4]});
    }).then(function() {
      /**********
      ...
      ***********/
      assert.notEqual(result.toString(), '0x0000000000000000000000000000000000000000', 'item 0 OK');
      /**********
      TASK 16: call winners function from accounts[0] to get the winner of item id 1
      ***********/
      return revealWinners(1,{from: accounts[0]});
    }).then(function(result) {
      /**********
      ...
      ***********/
      return revealWinners(2,{from: accounts[3]});
    }).then(function(result) {
      /**********
