...
contract('AuctionContract', function (accounts) {
  ...
  it("Should set winners", function() {
    ...
    ***********/
    return auctionInstance.register({from: account[2]
    }).then(function(result) {
      /**********
      TASK 8: Call register function from account 3
      ***********/
        return auctionInstance.register({from: account[3]
    }).then(function() {
      /**********
      TASK 9: Call register function from account 4
      ***********/
        return auctionInstance.register({from: account[4]
    }).then(function() {
      /**********
      ...
      ***********/
      return return auctionInstance.winners(2, {from: accounts[3]
    }).then(function(result) {
      /**********
